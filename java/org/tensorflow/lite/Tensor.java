...
//    throwIfDataIsIncompatible(src);//sally commented
    if (isByteBuffer(src)) {
...
//      long timest, timeend1, timeend2; //sally
//      timest = System.nanoTime(); //sally
//    throwIfDataIsIncompatible(dst); //sally commented
//      timeend1 = System.nanoTime(); //sally
 ...
 //     Log.i("Time","copy 1 time2: "+(timeend1-timest)/1000000.0 + "ms"); //sally
 //     Log.i("Time","copy 2 time2: "+(timeend2-timeend1)/1000000.0 + "ms"); //sally
