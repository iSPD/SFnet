...
final class NativeInterpreterWrapper implements AutoCloseable {
  ...
  private void init(long errorHandle, long modelHandle, Interpreter.Options options) {
    ...
    Log.i("TensorFlowLog", "sally TensorFlowLite init~~~~");
  ...
  void run(Object[] inputs, Map<Integer, Object> outputs) {
    ...
    //long timest, timeend1, timeend2;
    //timest = System.nanoTime(); //sally
...
//    timeend1 = System.nanoTime(); //sally
    for (Map.Entry<Integer, Object> output : outputs.entrySet()) {
      getOutputTensor(output.getKey()).copyTo(output.getValue());
    }
//    timeend2 = System.nanoTime(); //sally
//    Log.i("Time","shape time: "+(timeend1-timest)/1000000.0 + "ms"); //sally
//    Log.i("Time","copy time: "+(timeend2-timeend1)/1000000.0 + "ms"); //sally
//    Log.i("Time", "inferTime: " + inferenceDurationNanoseconds / 1000000.0 + "ms"); //sally
